...
const rootReducer = (state = initialState, action) => {
    ...
    switch (action.type) {
        ...
        case HIGHLIGHT_KEYWORDS:
            return {
                ...state,
                keywordsConfig: action.payload.keywordsConfig
            }    
